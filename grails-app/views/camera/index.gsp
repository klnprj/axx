...
<head>
    ...
    <asset:stylesheet src="font-awesome/stylesheets/font-awesome.min.css"/>
    <asset:stylesheet src="simple-line-icons/simple-line-icons.min.css"/>
    <asset:stylesheet src="bootstrap/stylesheets/bootstrap.min.css"/>
    <asset:stylesheet src="uniform/stylesheets/uniform.default.css"/>
    <asset:stylesheet src="bootstrap-switch/stylesheets/bootstrap-switch.min.css"/>

    <asset:stylesheet src="components-md.min.css"/>
    <asset:stylesheet src="plugins-md.min.css"/>

    <asset:stylesheet src="layout.min.css"/>
    <asset:stylesheet src="themes/default.min.css"/>
...
<div class="page-header">
    ...
    <div class="page-header-top">
        <div class="container">
            ...
            <div class="page-logo">
                <a href="index.html">
                    <img src="/assets/logo-default.jpg" alt="logo" class="logo-default">
                </a>
            </div>
            <!-- END LOGO -->
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                    <li>
                                        <a href="#">
                                            <span class="photo">
                                                <img src="/assets/avatar2.jpg" class="img-circle" alt=""> </span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
                                            <span class="photo">
                                                <img src="/assets/avatar3.jpg" class="img-circle" alt=""> </span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
                                            <span class="photo">
                                                <img src="/assets/avatar1.jpg" class="img-circle" alt=""> </span>
                                            <span class="subject">
                    ...
                    <li class="dropdown dropdown-user dropdown-dark">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <img alt="" class="img-circle" src="/assets/avatar9.jpg">
                    ...
                    <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                ...
                                <img class="media-object" src="/assets/avatar3.jpg" alt="...">
                            ...
                            <li class="media">
                                <img class="media-object" src="/assets/avatar1.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="/assets/avatar4.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="/assets/avatar2.jpg" alt="...">
                                <div class="media-body">
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                ...
                                <img class="media-object" src="/assets/avatar6.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="/assets/avatar7.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="/assets/avatar8.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="/assets/avatar9.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="/assets/avatar10.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="/assets/avatar11.jpg" alt="...">
                                <div class="media-body">
                    ...
                    <div class="page-quick-sidebar-item">
                        <div class="page-quick-sidebar-chat-user">
                            ...
                            <div class="page-quick-sidebar-chat-user-messages">
                                <div class="post out">
                                    <img class="avatar" alt="" src="/assets/avatar3.jpg" />
                                    <div class="message">
                                        <span class="arrow"></span>
                                ...
                                <div class="post in">
                                    <img class="avatar" alt="" src="/assets/avatar2.jpg" />
                                    <div class="message">
                                        <span class="arrow"></span>
...
<asset:javascript src="bootstrap/javascripts/bootstrap.min.js"/>
<asset:javascript src="js.cookie.min.js"/>
<asset:javascript src="bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js"/>
<asset:javascript src="jquery-slimscroll/jquery.slimscroll.min.js"/>
<asset:javascript src="jquery.blockui.min.js"/>
<asset:javascript src="uniform/jquery.uniform.min.js"/>
<asset:javascript src="bootstrap-switch/javascripts/bootstrap-switch.min.js"/>
<!-- END CORE PLUGINS -->
